...
class Tree extends React.Component {
  ...
  handleNodeToggle = (nodeId, evt) => {
    ...
    if (this.props.collapsible && !this.state.isTransitioning) {
      ...
      this.setState({ data, isTransitioning: true }, () => this.handleOnMouseDownCb(targetNode, evt));
      ...
      this.handleOnMouseDownCb(targetNode, evt);
    }
  };
  ...
  handleOnMouseDownCb = (targetNode, evt) => {
    const { onMouseDown } = this.props;
    if (onMouseDown && typeof onMouseDown === 'function') {
      onMouseDown(clone(targetNode), evt);
    }
  };
          ...
          >
            ...
            {nodes.map(nodeData => (
              <Node
                ...
                onMouseDown={this.handleNodeToggle}
